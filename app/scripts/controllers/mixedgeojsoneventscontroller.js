...
/**
 * @ngdoc function
 * @name angularLeafletExampleApp.controller:MixedgeojsoneventscontrollerCtrl
 * @description
 * # MixedgeojsoneventscontrollerCtrl
 * Controller of the angularLeafletExampleApp
 */
angular.module('angularLeafletExampleApp')
  .controller('MixedgeojsoneventscontrollerCtrl', [ '$scope', '$http', function($scope, $http) {
            ...
            $http.get("json/all.json").then(function(data) {
                ...
                $http.get("json/countries.geo.json").then(function(dt) {
                    angular.extend($scope, {
                        geojson: {
                            data: dt,
                            style: style,
